...
|---|---|---|---|---|---|
| Core transcription | OpenAI Whisper `base` | `openai-whisper==20250625`; expected SHA-256 `ed3a0b6b1c0edf879ad9b11b1af5a0e6ab5db9205f891f668f8b0e6c6326e34e` | [code and weights: MIT](https://github.com/openai/whisper) | 74M parameters; downloaded to the user's cache; audio is local unless the documented Google fallback runs | approved for opt-in download; do not bundle without repeating artifact verification |
