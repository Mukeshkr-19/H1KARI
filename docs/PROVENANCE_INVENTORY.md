...
| macOS CoreAudio capture helper | `native/macos_audio_capture/`, `core/voice_capture/` | local CoreAudio helper IPC; no disk recording | project code with selective MIT-adapted patterns from BasedHardware/omi @ `571c5d849fabb0b9e938129161ea5bb24a8e50fe`; see `docs/OMI_DERIVED_VOICE_PIPELINE.md` |
