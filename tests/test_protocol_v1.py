...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"type": "productivity_research_prepare", "request_id": "research-req-1", "query": "   "}, "Invalid field value: query"),
